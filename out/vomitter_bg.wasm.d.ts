...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7932c2619fce7bb0: (a: number, b: number) => void;
export const closure44466_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6d145d0f05bb56a6: (a: number, b: number) => void;
export const closure45705_externref_shim: (a: number, b: number, c: any) => void;
export const closure45714_externref_shim: (a: number, b: number, c: any, d: any) => void;
